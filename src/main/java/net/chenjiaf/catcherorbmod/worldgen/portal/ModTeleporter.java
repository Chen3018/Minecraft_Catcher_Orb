package net.chenjiaf.catcherorbmod.worldgen.portal;

import net.chenjiaf.catcherorbmod.block.ModBlocks;
import net.chenjiaf.catcherorbmod.block.custom.ModPortalBlock;
...
public class ModTeleporter implements ITeleporter {
    ...
    public Entity placeEntity(Entity entity, ServerLevel currentWorld, ServerLevel destinationWorld,
        ...
        if (insideDimension) {
            ...
            for (BlockPos checkPos : BlockPos.betweenClosed(destinationPos.below(10).west(),
